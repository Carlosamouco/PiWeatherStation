...
export abstract class ChartsBuilder {
  ...
  public abstract getHumDatasets(): any[];

  public abstract getPresDatasets(): any[];
  
  public abstract getTempDatasets(): any[];

  public abstract getLabels(): any[];

  public abstract getTempLineColors(): LineColor[];

  public abstract buildLabels(hData: any[]);

  protected calcColor(temperature: number): LineColor {
  ...
  protected RGBAtoRGB(r: number, g: number, b: number, a: number, r2 = 255, g2 = 255, b2 = 255) {
